...
<body>
<h2>Enter your Reservation Code (R_CODE)</h2>
<form name="Search" action="viewYourFlights" method="Post" class="form-wrapper">
<input type="text" id="search" placeholder="Search for Reservations" name="SearchId" value="R_CODE" required>
